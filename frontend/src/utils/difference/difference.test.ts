...
test("Expect correct difference with 1 month", () => {
  expect(difference(dayjs("2022-01-01"), dayjs("2022-02-01"))).toEqual("1 month");
});

test("Expect correct difference with 1 month + 1 day", () => {
  expect(difference(dayjs("2022-01-01"), dayjs("2022-02-02"))).toEqual("1 month");
});

test("Expect correct difference with 11 months", () => {
  expect(difference(dayjs("2021-01-01"), dayjs("2021-12-01"))).toEqual("11 months");
});

test("Expect correct difference with 12 months", () => {
  expect(difference(dayjs("2018-01-01"), dayjs("2019-01-01"))).toEqual("1 year");
});
